...
/**
 * Compute Partials & BE stats from trades (trades that are both Partials Taken and Break Even)
 */
          ...
          <div className="flex-1 w-full flex items-center justify-center min-h-0 relative">
            <div className="w-full h-full max-h-[200px] relative">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <defs>
                    <linearGradient id="partialsBEGrad0" x1="0" y1="0" x2="0" y2="1">
                  ...
                  <Pie
                    ...
                    dataKey="value"
                  >
                    <Cell key="cell-0" fill="url(#partialsBEGrad0)" stroke="none" />
                  </Pie>
                  <Tooltip
                    contentStyle={{
                      background: isDark
