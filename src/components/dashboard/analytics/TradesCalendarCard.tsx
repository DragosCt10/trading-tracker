            ...
            {[...emptyCells, ...daysInMonth].map((date, index) => {
              ...
              const baseColor =
                displayProfit > 0
                  ...
                  ? 'bg-orange-100/60 dark:bg-amber-800/35 border border-orange-200/70 dark:border-amber-600/40 hover:bg-orange-100/80 dark:hover:bg-amber-800/45 hover:border-orange-300/70 dark:hover:border-amber-500/45'
                  : hasBE && beOutcome === 'Win'
                  ? 'bg-emerald-500/10 dark:bg-emerald-500/20 border border-emerald-200 dark:border-emerald-800 hover:bg-emerald-500/15 dark:hover:bg-emerald-500/28 hover:border-emerald-300 dark:hover:border-emerald-700'
