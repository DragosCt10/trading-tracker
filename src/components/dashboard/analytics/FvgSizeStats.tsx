...
function CustomTooltip({
  ...
  return (
    <div className="relative overflow-y-auto overflow-x-hidden rounded-2xl border border-slate-300/40 dark:border-slate-700/50 bg-slate-50/80 dark:bg-slate-800/90 backdrop-blur-xl shadow-lg shadow-slate-900/5 dark:shadow-black/40 p-4 text-slate-900 dark:text-slate-100 max-h-[85vh]">
        ...
        <Card className="relative overflow-hidden border-slate-300/40 dark:border-slate-700/50 bg-slate-50/50 dark:bg-slate-800/30 shadow-md shadow-slate-200/50 dark:shadow-none backdrop-blur-sm h-[420px] flex flex-col">
          ...
          <CardContent className="flex-1 flex flex-col items-center justify-center">
            <div className="text-base font-medium text-slate-600 dark:text-slate-300 text-center mb-1">
              No FVG size data found
            </div>
            <div className="text-sm text-slate-500 dark:text-slate-400 text-center max-w-xs">
              Add trades with FVG Size to see distribution here.
            </div>
          </CardContent>
        </Card>
      );
          ...
          <div className="flex-1 w-full flex items-center justify-center min-h-0 relative pl-1 pr-4">
            <div className="w-full h-full relative">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  <defs>
                    <linearGradient id="fvgSizeStatsGradient" x1="0" y1="0" x2="1" y2="0">
