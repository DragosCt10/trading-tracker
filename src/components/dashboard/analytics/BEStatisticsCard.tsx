...
function CustomTooltip({
  ...
  active?: boolean;
  // Recharts' Tooltip payload shape is wider and typically has optional fields.
  // Keep this permissive to avoid build-time TS incompatibilities.
      ...
      <div className="relative flex flex-col">
        <div className="flex items-center gap-2">
          ...
          <div className="text-sm font-semibold text-slate-900 dark:text-slate-100">
            {name}: <span className={cn('font-bold', colors.text)}>{value}</span>
          </div>
        </div>
