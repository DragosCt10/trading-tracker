          ...
          <TooltipProvider>
            <UITooltip delayDuration={150}>
              ...
              <TooltipContent
                side="top"
                align="center"
                className="w-64 text-xs rounded-2xl p-3 relative overflow-hidden border border-slate-300/40 dark:border-slate-700/50 bg-slate-50/80 dark:bg-slate-800/90 backdrop-blur-xl shadow-lg shadow-slate-900/5 dark:shadow-black/40 text-slate-900 dark:text-slate-100"
                sideOffset={6}
              >
