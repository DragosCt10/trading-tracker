          ...
          <div className="hidden lg:flex items-center gap-3 flex-shrink-0 header-entrance header-entrance-delay-3">
            ...
            {SOCIAL_LINKS.map(({ label, href, Icon }) => (
              <a
                ...
                className="h-8 w-8 rounded-lg flex items-center justify-center text-muted-foreground hover:text-slate-900 dark:hover:text-white transition-all duration-300 hover:shadow-[0_0_12px_color-mix(in_oklch,var(--tc-primary)_30%,transparent)]"
                ...
                <div className="mt-6 flex items-center justify-center gap-3">
                  {SOCIAL_LINKS.map(({ label, href, Icon }) => (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="h-10 w-10 rounded-xl flex items-center justify-center text-slate-500 dark:text-white/60 hover:text-slate-900 dark:hover:text-white bg-slate-100/50 dark:bg-white/[0.04] hover:bg-slate-100 dark:hover:bg-white/[0.08] transition-all duration-300"
                      aria-label={`Follow AlphaStats on ${label}`}
                    >
                      <Icon className="h-4 w-4" />
                    </a>
