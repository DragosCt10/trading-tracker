...
export default function PostCardSkeleton() {
  return (
    <div className={`${FEED_CARD_SKELETON_SURFACE_CLASS} p-5`}>
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0 space-y-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="h-3 w-16 rounded bg-slate-200/70 dark:bg-slate-700/50" />
          </div>
          {/* Content lines */}
      ...
      {/* Action bar */}
      <div className="flex items-center gap-4 mt-4 pt-3 border-t border-slate-200/80 dark:border-slate-700/40">
        <div className="h-7 w-14 rounded-lg bg-slate-200/80 dark:bg-slate-700/50" />
        <div className="h-7 w-14 rounded-lg bg-slate-200/80 dark:bg-slate-700/50" />
        <div className="h-7 w-10 rounded-lg bg-slate-200/80 dark:bg-slate-700/50" />
      </div>
    </div>
  );
}
