...
export default function ResetPasswordClient() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4 transition-colors duration-500 bg-transparent">
      ...
      {/* Theme toggle button — theme-aware */}
      <button
        onClick={toggleTheme}
        className="absolute top-6 right-4 z-50 p-3 rounded-xl bg-muted/50 border border-border backdrop-blur-md shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 group text-foreground"
