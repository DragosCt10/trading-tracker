...
export default function ManageTradesClient({
  ...
  const handleBulkDelete = async () => {
    ...
    try {
      ...
      // Invalidate dashboard stats and calendar so navigating back to the dashboard shows fresh data.
      queryClient.invalidateQueries({
        predicate: (q) => {
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          {trade.partials_taken && (
                            <Tooltip>
                              ...
                              <TooltipContent side="top" className="rounded-xl border border-slate-200/70 dark:border-slate-700/50 bg-slate-50/80 dark:bg-slate-800/30 backdrop-blur-xl shadow-lg shadow-slate-900/5 dark:shadow-black/40 text-slate-900 dark:text-slate-50 p-2.5">
