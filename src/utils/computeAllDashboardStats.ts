...
function buildNonExecRpcResult(nonExecTrades: Trade[]): DashboardRpcResult {
  ...
  return {
    ...
    series_stats: { maxDrawdown: 0, drawdownCount: 0, currentStreak: 0, maxWinningStreak: 0, maxLosingStreak: 0, sharpeWithBE: 0, tradeQualityIndex: 0 },
...
export function computeAllDashboardStats(
  ...
  return {
    ...
    series_stats: { maxDrawdown, drawdownCount: 0, currentStreak, maxWinningStreak, maxLosingStreak, sharpeWithBE, tradeQualityIndex },
    evaluation_stats,
    risk_analysis,
    monthly_data, best_month, worst_month,
    ...
    maxDrawdown, drawdownCount: 0, currentStreak, maxWinningStreak, maxLosingStreak,
